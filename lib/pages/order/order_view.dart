...
import 'package:ifood_delivery/pages/order/order_shimmer.dart';
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        if(orderController.isLoading==false){
          ...
          if(orderController.runningOrderList.isNotEmpty) {
            orderList = isRunning ? orderController.runningOrderList.reversed.toList()
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      onTap: () {
                        Get.toNamed(
                        RouteHelper.getOrderDetailsPage(orderList[index].id),
                        arguments: OrderDetailPage(orderId: orderList[index].id, orderModel: orderList[index]),
                        );
                      },
                      child: Container(
                          ...
                          Row(children: [
                            ...
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Row(children: [
                                  Text('${'Mã đơn hàng'.tr}:', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                              ...
                              isRunning ? InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Row(children: [
                                    ...
                                    SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                    Text('Theo dõi thứ tự'.tr, style: robotoMedium.copyWith(
                                      fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor,
                                    )),
                                  ]),
                                ),
                              ) : Text(
                                '${orderList[index].detailsCount} ${orderList[index].detailsCount! > 1 ? 'mặt hàng' : 'mặt hàng'}',
          ...
          NoDataPage(text: 'No order found'.tr) ):
