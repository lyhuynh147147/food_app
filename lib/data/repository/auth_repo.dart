...
class AuthRepo{
  ...
  Future registration(SignUpBody signUpBody) async{
    return await apiClient.postData(AppConstants.BASE_URL+AppConstants.REGISTRATION_URI,signUpBody.toJson());
  }
  ...
  Future login(String phone, String password) async{
    return await apiClient.postData(AppConstants.BASE_URL+AppConstants.LOGIN_URI,
        {
          'phone': phone,
          'password': password,
        });
  ...
  Future updateToken() async {
    ...
    return await apiClient.postData2(AppConstants.TOKEN_URI, {"_method": "put", "cm_firebase_token": _deviceToken});
  }
